...
// @namespace      https://github.com/XpliSyL/Leek-Wars-Scripts/
// @version        0.4
...
(function() {
    ...
    function replace() {
        ...
        loaded = true;
        $('#popups div.view div.column.column-scenario')
            .first()
            .append('<div class = "rapport"><label style="margin-left: 20px;"><input type="checkbox" ' + (localStorage.getItem('EFNT-showreport') === 'true' ? 'checked="true"' : '') + ' id="EFNT-report2"> Afficher rapport</label></div>');
        ...
        clone.addEventListener('click', function() {
            var scenario_data = localStorage['editor/last-scenario-data'];
